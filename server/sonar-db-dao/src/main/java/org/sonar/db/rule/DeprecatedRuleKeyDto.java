...
public class DeprecatedRuleKeyDto {
  ...
  /**
   * current repository key retrieved from an external join if rule_id
   */
  private String newRepositoryKey;
  /**
   * current rule key retrieved from an external join if rule_id
   */
